...
local basicParams = {
	...
	{ FileUpload, "auth_user_pass",	"/etc/openvpn/userpass.txt", translate("Authenticate using username/password") },
	...
	{ FileUpload,"config","/etc/openvpn/some-client.ovpn", translate("OVPN file") },
}
