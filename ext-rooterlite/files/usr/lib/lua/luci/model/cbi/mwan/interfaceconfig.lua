...
dwnscript = mwan_interface:option(Value, "dwnscript", translate("Interface Down Script"),
	translate("Script to run when Interface is deemed down"))
	dwnscript.default = "/usr/lib/rooter/idown.lua"
